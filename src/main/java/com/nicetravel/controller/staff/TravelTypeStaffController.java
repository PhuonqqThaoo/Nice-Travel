...
public class TravelTypeStaffController {
	...
	@Autowired
	public TravelTypeStaffController( AccountService accountService,TravelTypeService travelTypeService) {
	...
	public String doGetEdit(@RequestParam("id") Integer id, Model model) {
		...
		return "staff/quan-ly/tour-du-lich/QuanLy-TravelType::#form";
	}
...
//				travelTypeRequest.setSlug(slug);
		...
		return "redirect:/staff/travel-type";
	}
